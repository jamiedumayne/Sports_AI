...
os.chdir("C:/Users/jamie/Files/Code/sports_tracker/football_tracker/resources")
...
video_title = cv2.VideoCapture("Football_test.mp4")

out = cv2.VideoWriter('football_vid_box.avi',
...
dataset.to_csv('football_test.csv', index=False)
