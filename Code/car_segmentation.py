...
os.chdir("C:/Users/jamie/Files/Code/sports_tracker/F1_tracker/test_resources")
...
video_title = cv2.VideoCapture("car_short.mp4")

out = cv2.VideoWriter('car_vid_box.avi',
...
dataset.to_csv('one_car.csv', index=False)
...
#to do
#figure out why blender can't match to objects

#link for training a custom yolov8 model https://learnopencv.com/train-yolov8-on-custom-dataset/#Train-YOLOv8-on-the-Custom-Pothole-Detection-Dataset
